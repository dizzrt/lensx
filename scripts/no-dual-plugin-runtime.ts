...
const exactAllowlist: Readonly<Record<string, readonly string[] | 'all'>> = Object.freeze({
  ...
  'plugins/official/config-lens/scripts/check.mjs': ['legacy-sdk-entry', 'legacy-sdk-factory'],
  'plugins/official/config-lens/scripts/test-e2e.mjs': ['legacy-sdk-entry', 'legacy-sdk-factory'],
