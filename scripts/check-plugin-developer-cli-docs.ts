...
const requiredByPath = new Map<string, readonly string[]>([
  ...
  ['docs/en/development/plugin-workspace.md', ['@lensx/plugin-cli', 'pnpm run gate -- plugin-developer-cli']],
  ['docs/zh/development/plugin-workspace.md', ['@lensx/plugin-cli', 'pnpm run gate -- plugin-developer-cli']],
